...
public class ProcessListAdapter extends ArrayAdapter<ProcessData> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            if(holder.processData.getAppData().toString() != null) {
                //át kell parszolni, különben átírja a textview id-ját valahogy :D
                holder.pid.setText(Integer.toString(holder.processData.getAppData().getmPID()));
                holder.name.setText(holder.processData.getAppData().getmName());
                holder.pkgName.setText(holder.processData.getAppData().getmPackage());
                holder.additionalInfo.setText(holder.processData.getMemData().toString());
            }
            return convertView;
